        ...
        <div class="max-w-full mx-auto sm:px-6 lg:px-8">
            ...
            <thead class="text-xs text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-400 ">
                ...
                <th class="border px-4 py-2">ID</th>
                    ...
                    <th class="border px-4 py-2 text-center" colspan="2">Action</th>
                        ...
                        <form method="POST" action="{{ route('update.etat', $stg->id) }} " >
                                ...
                                <td class="border px-4 py-2  flex flex-col items-center ">
                                    <form method="POST" action="{{ route('update.another', $stg->id) }}">
                                        ...
                                        @method('PUT')
                                        <button type="submit"
                                            class="bg-white hover:bg-red-700 text-black  hover:text-white font-bold py-2 px-4 rounded">
                                           non-valider
                                        </button>
                                    </form>
                                </td> <!-- Add the form with the second button -->
                            </tr>
                @endforeach
            </tbody>
        </table>
