...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
   <head>
      ...
      <style>
         ...
         .left-img{
         background-image: url('{{ asset('background/workers.jpg')}}');
         background-position: center;
         }
         .right-img{
         background-image: url('{{ asset('background/stagiaire.jpg')}}');
         background-position: center; 
   ...
   <body class="h-screen flex">
      <div class="w-1/2 h-full flex flex-col justify-center items-center bg-gray-500 relative left-img" >
         <h2 class="absolute left-1/2 top-10 transform -translate-x-1/2 text-4xl font-extrabold dark:text-gray-700">Espace Admin </h2>
